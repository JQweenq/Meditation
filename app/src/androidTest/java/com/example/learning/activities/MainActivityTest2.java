...
public class MainActivityTest2 {
    ...
    public void mainActivityTest2() {
        ViewInteraction materialButton = onView(
                allOf(withId(R.id.login_button), withText("Войти в аккаунт"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.full_frame),
                                        0),
                                3),
                        isDisplayed()));
        ...
        ViewInteraction textView = onView(
                allOf(IsInstanceOf.<View>instanceOf(android.widget.TextView.class), withText("Ошибка"),
